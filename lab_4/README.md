...
Init (контейнер с обучением модели, логированием метаданных и сохранением модели посредством mlflow; реализовано как Job, чтобы отработало единожды):<img width="651" alt="Снимок экрана 2024-12-15 в 17 47 26" src="https://github.com/user-attachments/assets/504cc12a-6b76-44ea-94b1-97d2ed567ecb" />
